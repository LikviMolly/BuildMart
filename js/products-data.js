    ...
    accordion: [
      {
        title: "Technical Specifications",
        items: [
          { label: "Weight", value: "50 lbs per lag" },
    ...
    accordion: [
      {
        title: "Technical Specifications",
        items: [
          { label: "Dimensions", value: "8 x 3.75 x 2.25 in" },
          { label: "Material", value: "Fired Red Clay" },
          { label: "Compressive Strength", value: "3000+ PSI" },
          { label: "Water Absorption", value: "Less than 8%" },
          { label: "Color", value: "Сlassic Red" },
    ...
    accordion: [
      {
        ...
        items: [
          ...
          { label: "Material", value: "Structural Carbon Steel" },
